...
--visuals:
  ...
  for z=5,.07,-.01 do
    ...
    prim(
      ...
      70+19/z*s(l/3),
      99/z,
      (1-z/4-N[1]/4+s(z+t/9)^8*6*N[0]/15)
       *(.5-p%2)*(15-N[3])/8
    )
    l=p<3 and l//1 or l    
    for i=0,9 do
	    prim(
       p%5,
       120+(s(i*p+l)+1.5+i/9)/z*19*s(i*8+s(i*4+l)+s(s(t/20)+t/30)),
        70+(s(i*p+l)+1.5+i/9)/z*19*s(i*8+s(i*4+l)+s(s(t/20)+t/30)+8),
       3/z,
       2^-z*N[3]*(.5-p%2)
      )
    end
